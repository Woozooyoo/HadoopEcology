...
public class CalleeWriteObserver extends BaseRegionObserver {
	...
	public void postPut(ObserverContext<RegionCoprocessorEnvironment> e, Put put, WALEdit edit, Durability durability) throws IOException {
		...
		//01_18576581848_20170814133831_17269452013_1_1761
		...
		int regionNum = Integer.valueOf (PropertiesUtil.getProperty ("hbase.calllog.regions"));
		//被叫的数据的RowKey的第一个参数 regionCode
		String regionCode = HBaseUtil.genRegionCode (callee, buildTime, regionNum);
